...
/// <summary>
/// Tests for <see cref="ContentManagerService"/>'s texture-from-file load/reload path
...
/// </summary>
public class ContentManagerServiceTextureTests
{
    ...
    {
        // Non-Texture2D types should delegate to MonoGame's ContentManager path.
