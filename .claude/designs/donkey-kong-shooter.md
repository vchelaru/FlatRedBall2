# Square Fury — Game Design Document
...
The cycle timing should be tuned so that the player has clear windows to advance or shoot during the Pace and Hop phases, but must dodge or take cover during the Shoot phase.
