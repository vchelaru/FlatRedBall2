...
/// <summary>
/// Extension methods on <see cref="ContentManagerService"/> for loading animation content.
...
/// </summary>
public static class ContentManagerServiceAnimationExtensions
{
    /// <summary>
    ...
    /// <see cref="ContentManagerService.Load{T}"/> (so PNG hot-reload still applies).
    /// </summary>
    public static AnimationChainList LoadAnimationChainList(this ContentManagerService content, string path)
    ...
    /// the sibling atlas PNG is loaded through <see cref="ContentManagerService.Load{T}"/>.
    /// </summary>
    ...
    public static AnimationChainList LoadAdobeAnimateAtlas(this ContentManagerService content, string path, float frameRate = 30f)
