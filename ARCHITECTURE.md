...
No `Scale` property. Entities should also have a Z value that can control children Z. Children Z is relative to entity Z.
...
public interface ICollidable
{
    ...
    void SeparateFrom(ICollidable other);        // moves parent entity if attached, else moves self
    void AdjustVelocityFrom(ICollidable other);  // modifies parent entity velocity if attached, else self
}
...
var engine = new FlatRedBallService(mockGame);
